...
<h3>ShopZilla</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Welcome to our website! We are a team of dedicated professionals who are passionate about providing our customers with the highest quality products and services.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="">www.contactus.com</a></span>
                </div>
            </li>
